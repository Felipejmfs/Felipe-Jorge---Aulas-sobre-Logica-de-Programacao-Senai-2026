...
function ehVogal(letra) {
    ...
    else if (letra == "E" || letra == "e") return true
    else if (letra == "I" || letra == "i") return true
    else if (letra == "O" || letra == "o") return true
    else if (letra == "U" || letra == "u") return true
    else return false
}

// → Seu código aqui:
console.log(ehPar(3));
console.log(ehMaiorDeIdade(21));
console.log(ehVogal("d"));

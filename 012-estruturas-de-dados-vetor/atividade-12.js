...
// → Seu código aqui:
let cidades = ["Jaraguá", "Jaraguá do Centro", "Jaraguá do Sul", "Jaraguá do Norte", "Jaraguá do Nordeste"]

for (let i = 0; i < cidades.length; i++){
  console.log(cidades[i]);
}

console.log("Primeira cidade: ", cidades[0], "Última cidade: ", cidades[cidades.length - 1]);
...
for (let i = vetorOriginal.length - 1; 0 <= i; i--) {
  vetorInvertido.push(vetorOriginal[i])
}
console.log(`Original:  ${vetorOriginal}`);
console.log(`Original:  ${vetorInvertido}`);
